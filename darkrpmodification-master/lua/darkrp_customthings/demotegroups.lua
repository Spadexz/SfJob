...
DarkRP.createDemoteGroup("Polices", {TEAM_MAYOR, TEAM_POLICE, TEAM_CHIEF, TEAM_SERVICE, TEAM_SWATA, TEAM_SWATM, TEAM_SWATC, TEAM_SWAT})
DarkRP.createDemoteGroup("Hobos", {TEAM_HOBOL, TEAM_HOBO})
-- DarkRP.createDemoteGroup("Terrorists", {TEAM_OSAMBA, TEAM_TERRORIST})
...
GAMEMODE:AddGroupChat(TEAM_STAFF, TEAM_STAFF)
GAMEMODE:AddGroupChat(TEAM_MAYOR, TEAM_POLICE, TEAM_CHIEF, TEAM_SERVICE, TEAM_SWATA, TEAM_SWATM, TEAM_SWATC, TEAM_SWAT)
GAMEMODE:AddGroupChat(TEAM_HOBOL, TEAM_HOBO)
GAMEMODE:AddGroupChat(TEAM_OSAMA, TEAM_TERRORIST)
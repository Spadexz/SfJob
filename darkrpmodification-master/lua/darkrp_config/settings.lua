...
GM.Config.PocketBlacklist = {
        ...
        ["money_printer"] = true,
        ["gunlab"] = true,
        ["npc_mayorvoting"] = true,
        ["models/props_junk/harpoon002a.mdl"] = true,
        ["models/props_c17/consolebox01a.mdl"] = true,
        ["models/katharsmodels/contraband/zak_wiet/zak_wiet.mdl"] = true,
        ["models/drug_mod/the_bottle_of_water.mdl"] = true,
        ["models/marioragdoll/super mario galaxy/star/star.mdl"] = true,
        ["models/jaanus/aspbtl.mdl"] = true,
        ["models/drug_mod/alcohol_can.mdl"] = true,
        ["models/boxopencigshib.mdl"] = true,
        ["models/cocn.mdl"] = true,
        ["models/katharsmodels/syringe_out/syringe_out.mdl"] = true,
        ["models/smile/smile.mdl"] = true,
        ["models/ipha/mushroom_small.mdl"] = true,

...
RP_MySQLConfig.Host = "reignttt.reignnetwork.site.nfoservers.com" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
RP_MySQLConfig.Username = "reignnetwork" -- This is the username to log in on the MySQL server.
								-- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
RP_MySQLConfig.Password = "3uogNX5x5c" -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = "reignnetwork_reigndarkrp" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
